...
class ResumeParsingService
{
    ...
    {
        return "You are tasked with extracting information from a resume provided in text format (converted from PDF) and structuring it into a specific JSON format. The text of the resume will be provided in the following XML tags:
